<?php if (get_field('include_news_footer_cta', 'option')) : ?>
	<?php if (get_field('news_footer_cta_use_global_content', 'option')) : ?>
		<?php get_template_part('parts/_template_parts/footer_cta_global'); ?>
	<?php else : ?>
		<?php if (have_rows('news_footer_cta', 'option')) : ?>
			<?php while (have_rows('news_footer_cta', 'option')) : the_row(); ?>
