<?php if (get_field('include_academic_users_footer_cta', 'option')) : ?>
	<?php if (get_field('academic_users_footer_cta_use_global_content', 'option')) : ?>
		<?php get_template_part('parts/_template_parts/footer_cta_global'); ?>
	<?php else : ?>
		<?php if (have_rows('academic_users_footer_cta', 'option')) : ?>
			<?php while (have_rows('academic_users_footer_cta', 'option')) : the_row(); ?>
