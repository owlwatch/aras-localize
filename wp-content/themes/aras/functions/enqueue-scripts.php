...
function site_scripts()
{
  ...
  wp_enqueue_style('site-css', get_template_directory_uri() . '/assets/styles/style_0702b.css', array(), filemtime(get_stylesheet_directory() . '/assets/styles/style_0702b.css'), 'all');
...
{
  add_editor_style(get_template_directory_uri() . '/assets/styles/style_0702b.css');
}
