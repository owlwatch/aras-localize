...
{
	$labels = array(
		"name"                  => __('Resources', 'aras'),
		"singular_name"         => __('Resource', 'aras'),
		'menu_name'             => __('Resources', 'aras'),
		'name_admin_bar'        => __('Resources', 'aras'),
		'archives'              => __('Resource Archives', 'aras'),
		'attributes'            => __('Resource Attributes', 'aras'),
		'parent_item_colon'     => __('Resource Resource:', 'aras'),
		'all_items'             => __('All Resources', 'aras'),
		'add_new_item'          => __('Add New Resource', 'aras'),
		'add_new'               => __('Add New', 'aras'),
		'new_item'              => __('New Resource', 'aras'),
		'edit_item'             => __('Edit Resource', 'aras'),
		'update_item'           => __('Update Resource', 'aras'),
		'view_item'             => __('View Resource', 'aras'),
		'view_items'            => __('View Resources', 'aras'),
		'search_items'          => __('Search Resources', 'aras'),
		...
		'insert_into_item'      => __('Insert into Resource', 'aras'),
		'uploaded_to_this_item' => __('Uploaded to this Resource', 'aras'),
		'items_list'            => __('Resource list', 'aras'),
		'items_list_navigation' => __('Resource list navigation', 'aras'),
		'filter_items_list'     => __('Filter Resource list', 'aras'),
	);
	$args = array(
		'label'                 => __('Resource', 'aras'),
		'description'           => __('Resource Post Type', 'aras'),
		'labels'                => $labels,
