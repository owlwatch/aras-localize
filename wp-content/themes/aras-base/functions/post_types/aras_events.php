...
function cptui_register_my_cpts_event()
{
	$labels = array(
		"name"                  => __('Events', 'aras'),
		"singular_name"         => __('Event', 'aras'),
		'menu_name'             => __('Events', 'aras'),
		'name_admin_bar'        => __('Events', 'aras'),
		'archives'              => __('Event Archives', 'aras'),
		'attributes'            => __('Event Attributes', 'aras'),
		'parent_item_colon'     => __('Event Event:', 'aras'),
		'all_items'             => __('All Events', 'aras'),
		'add_new_item'          => __('Add New Event', 'aras'),
		'add_new'               => __('Add New', 'aras'),
		'new_item'              => __('New Event', 'aras'),
		'edit_item'             => __('Edit Event', 'aras'),
		'update_item'           => __('Update Event', 'aras'),
		'view_item'             => __('View Event', 'aras'),
		'view_items'            => __('View Events', 'aras'),
		'search_items'          => __('Search Events', 'aras'),
		...
		'insert_into_item'      => __('Insert into Event', 'aras'),
		'uploaded_to_this_item' => __('Uploaded to this Event', 'aras'),
		'items_list'            => __('Event list', 'aras'),
		'items_list_navigation' => __('Event list navigation', 'aras'),
		'filter_items_list'     => __('Filter Event list', 'aras'),
	);
	$args = array(
		'label'                 => __('Event', 'aras'),
		'description'           => __('Event Post Event Type', 'aras'),
		'labels'                => $labels,
