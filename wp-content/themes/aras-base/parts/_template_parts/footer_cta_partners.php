<?php if (get_field('include_partner_footer_cta', 'option')) : ?>
	<?php if (get_field('partner_footer_cta_use_global_content', 'option')) : ?>
		<?php get_template_part('parts/_template_parts/footer_cta_global'); ?>
	<?php else : ?>
		<?php if (have_rows('partner_footer_cta', 'option')) : ?>
			<?php while (have_rows('partner_footer_cta', 'option')) : the_row(); ?>
